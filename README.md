...
下方以及页面初始加载的“沈砚”简历均为虚构演示数据，其中的姓名、院校、公司与数字均为编造，仅用于展示高密度单页排版效果，不代表任何人的真实教育或工作经历。
...
本项目基于 [gracexygu/resume-formatter](https://github.com/gracexygu/resume-formatter) 修改，原项目以 MIT 协议发布。

本仓库的改动：

- 修复新增条目时「时间」「身份」字段因空内容宽度塌陷而无法点击编辑的问题
- 更换默认演示简历内容
